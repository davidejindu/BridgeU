...
import { ArrowLeft, Globe, Wrench, Languages, Scale, X, CheckCircle } from 'lucide-react';
import { useAuth } from '../contexts/AuthContext';
import { getLearningContent, generateQuiz, submitQuiz, LearningContent, QuizQuestion, QuizResult } from '../services/learningService';
...
const CategoryDetail: React.FC = () => {
  ...
  const [activeModal, setActiveModal] = useState<'learn' | 'quiz' | 'result' | null>(null);
  ...
  const categoryData = {
    'culture': {
      ...
      subcategories: [
        {
          title: 'Campus Life',
          description: 'Understanding campus culture, social norms, and student life',
          difficulty: 'Beginner',
        ...
        },
        {
          ...
          description: 'Social etiquette, communication styles, and cultural behaviors',
    ...
    'practical-skills': {
      ...
      subcategories: [
        {
          title: 'Banking',
          description: 'Opening accounts, managing finances, and understanding banking systems',
          difficulty: 'Beginner',
          difficultyColor: 'bg-green-500',
          topics: 4,
          time: '6 min'
        ...
        {
          title: 'Healthcare',
          description: 'Health insurance, finding doctors, and medical services',
          difficulty: 'Intermediate',
          difficultyColor: 'bg-yellow-500',
          topics: 4,
          time: '10 min'
      ...
      subcategories: [
        {
          ...
          description: 'Modern slang, internet language, and youth culture terms',
          difficulty: 'Advanced',
      ...
      subcategories: [
        {
          ...
          description: 'Requirements, deadlines, and compliance for student visas',
          difficulty: 'Advanced',
          difficultyColor: 'bg-red-500',
          topics: 4,
          time: '15 min'
        ...
        {
          title: 'Campus Jobs',
          description: 'Work authorization, job search, and employment regulations',
          difficulty: 'Intermediate',
          difficultyColor: 'bg-yellow-500',
          topics: 4,
          time: '12 min'
        ...
        {
          title: 'Laws',
          description: 'Important laws and regulations affecting international students',
          difficulty: 'Advanced',
          difficultyColor: 'bg-red-500',
          topics: 4,
          time: '18 min'
        },
        {
          ...
          description: 'Paperwork, legal requirements, and staying updated with ISO',
          difficulty: 'Intermediate',
          difficultyColor: 'bg-yellow-500',
          topics: 4,
          time: '10 min'
  ...
  const handleTakeQuiz = async (subcategoryTitle: string) => {
    ...
    try {
      ...
      if (questions.length < 5) {
        console.warn(`Only ${questions.length} questions generated, expected at least 5`);
      }
          ...
          {category.subcategories.map((subcategory, index) => (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <h3 className="text-xl font-semibold text-gray-900">{subcategory.title}</h3>
              ...
              <div className="flex items-center justify-between mb-4">
                <span className={`px-2 py-1 rounded text-xs font-medium text-white ${subcategory.difficultyColor}`}>
                  {subcategory.difficulty}
                </span>
                <span className="text-sm text-gray-500">
                  {subcategory.topics} topics • {subcategory.time}
                </span>
              </div>
              ...
              <div className="flex gap-2">
                ...
                >
                  {isLoading && currentSubcategory === subcategory.title ? 'Loading...' : 'Learn'}
                </button>
                <button
                ...
                >
                  {isLoading && currentSubcategory === subcategory.title ? 'Loading...' : 'Take Quiz'}
                </button>
              </div>
            </div>
          ))}
        ...
        <div className="fixed inset-0 bg-white z-50 flex flex-col">
          <div className="bg-white w-full h-full overflow-hidden flex flex-col">
            <div className="flex items-center justify-between p-6 border-b">
              <h2 className="text-2xl font-bold text-gray-900">{learningContent.title}</h2>
              <button
                onClick={closeModal}
                  ...
                  dangerouslySetInnerHTML={{ 
                    __html: (() => {
                      ...
                      return content
                        ...
                        .replace(/^#### (.*$)/gim, '<h4 class="text-lg font-medium text-gray-800 mt-4 mb-2">$1</h4>')
            ...
            <div className="p-6 border-t bg-gray-50 flex-shrink-0">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-500">
                  Difficulty: <span className="font-medium">{learningContent.difficulty}</span>
                </span>
                <button
                  onClick={closeModal}
          ...
          <div className="bg-white px-6 py-4 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <h1 className="text-2xl font-bold text-gray-900">IS International Student Hub</h1>
              </div>
                ...
                <>
                  ...
                  <div className="space-y-4 mb-8">
                    {quizQuestions[currentQuestionIndex].options.map((option, optionIndex) => {
                      ...
                      const isSelected = quizAnswers[currentQuestionIndex] === option;
                      
                      return (
                        <button
                          key={optionIndex}
                          onClick={() => handleQuizAnswerChange(currentQuestionIndex, option)}
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    {currentQuestionIndex === quizQuestions.length - 1 ? (
                      <button
                        ...
                        disabled={isLoading || quizAnswers.some(answer => answer === '')}
